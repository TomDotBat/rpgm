...
function RPGM.DrawRoundedBoxEx(borderSize, x, y, w, h, col, topLeft, topRight, bottomLeft, bottomRight)
...
local drawRoundedBoxEx = RPGM.DrawRoundedBoxEx
...
function RPGM.DrawFullRoundedBoxEx(borderSize, x, y, w, h, col, tl, tr, bl, br)
	setDrawColor(col.r, col.g, col.b, col.a)
...
function RPGM.DrawFullRoundedBox(borderSize, x, y, w, h, col)
	return RPGM.DrawFullRoundedBoxEx(borderSize, x, y, w, h, col, true, true, true, true)
end